...
import static com.shorty.logger.Logger.ASSERT;
import static com.shorty.logger.Logger.DEBUG;
import static com.shorty.logger.Logger.ERROR;
import static com.shorty.logger.Logger.INFO;
import static com.shorty.logger.Logger.VERBOSE;
import static com.shorty.logger.Logger.WARN;
...
//                .tag("My custom tag")   // (Optional) Custom tag for each log. Default PRETTY_LOGGER
        ...
        addAdapter(new AndroidLogAdapter(formatStrategy));

        addAdapter(new DiskLogAdapter() {
            @Override
            public boolean isLoggable(int priority, @Nullable String tag) {
                return BuildConfig.DEBUG || priority > DEBUG;
            }
        });
    }

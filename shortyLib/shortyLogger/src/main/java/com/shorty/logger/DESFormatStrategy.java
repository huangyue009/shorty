 ...
 * @since 2020-02-27
 */
public class DESFormatStrategy implements FormatStrategy {
  ...
  private DESFormatStrategy(@NonNull Builder builder) {
  ...
  public static final class Builder {
    ...
    @NonNull public DESFormatStrategy build() {
      if (date == null) {
        date = new Date();
      }
      if (dateFormat == null) {
      ...
      if (logStrategy == null) {
        ...
        ht.start();
        Handler handler = new DiskLogStrategy.WriteHandler(ht.getLooper(), folder, DiskLogStrategy.TXT);
        logStrategy = new DiskLogStrategy(handler);
      }
      return new DESFormatStrategy(this);
    }
  }
}
